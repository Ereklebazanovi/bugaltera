...
async function handleConfirm() {
    ...
    try {
      ...
      await addDoc(collection(db, 'mail'), {
        to: ['Balance.101@Outlook.com', 'bazanovierekle4@gmail.com'], // ადმინების იმეილები მერე უნდა შევცვალო ბალანსის ადმინების მეილები რაც იქნება იმაზე რომ მიუვიდეთ ფორმის შევსების ნოტიფიკაციები პირდაპირ მეილზე რომ შეამოწმონ ადმინ პანელი
        message: {
     ...
     <motion.div
      ...
      >
        ...
        <div className="mt-10 pt-6 border-t border-stone-100">
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-10 mb-5">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              aria-label="Facebook"
              className="flex items-center justify-center w-10 h-10 rounded-full border border-[#1877F2]/30 text-[#1877F2]/60 hover:border-[#1877F2] hover:text-[#1877F2] hover:bg-[#1877F2]/8 transition-all duration-200"
            >
            ...
            <a
              ...
              className="flex items-center justify-center w-10 h-10 rounded-full border border-[#E1306C]/30 text-[#E1306C]/60 hover:border-[#E1306C] hover:text-[#E1306C] hover:bg-[#E1306C]/8 transition-all duration-200"
            >
              <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
